...
package org.ushodaya.dataplatform.data.api.data.format;

import org.ushodaya.dataplatform.data.api.annotation.Beta;
import org.ushodaya.dataplatform.data.api.common.Bytes;
import org.ushodaya.dataplatform.data.api.data.schema.Schema;
import org.ushodaya.dataplatform.data.api.data.schema.Schema.LogicalType;
import org.ushodaya.dataplatform.data.api.data.schema.SchemaCache;
...
public class StructuredRecord implements Serializable {
   ...
   * {@link LogicalType#TIMESTAMP_MILLIS} or {@link LogicalType#TIMESTAMP_MICROS} as
   * its logical type.
   *
   ...
   * LogicalType#TIMESTAMP_MILLIS} or {@link LogicalType#TIMESTAMP_MICROS} as its
   * logical type.
   *
   * @param fieldName zoned date time field to get.
   ...
   * DateTimeFormatter#ISO_LOCAL_DATE_TIME}. Use get() to retrieve value as
   * string.
   *
  ...
  public static class Builder {
     ...
     * precision should be less than or equal to precision provided in {@link LogicalType}
     ...
     *     field
     * @deprecated As of release 5.1.0, use {@link Builder#setDate(String,
     *     LocalDate)} instead.
     */
    @Deprecated
